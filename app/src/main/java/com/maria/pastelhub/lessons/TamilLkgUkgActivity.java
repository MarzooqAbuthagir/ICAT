...
public class TamilLkgUkgActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tamil_lkg_ukg);
        pref = new Pref(this);
        networkStatus();
        ...
        if (lanuage.equals("1")) {
            ...
            } else if (choice.equals("tamilOne")) {
                activity_ten.setVisibility(View.VISIBLE);
                activity_eight.setVisibility(View.VISIBLE);
                activity_nine.setVisibility(View.VISIBLE);
                activity_eleven.setVisibility(View.VISIBLE);
            ...
            } else if (choice.equals("tamilTwo")) {
                activity_ten.setVisibility(View.VISIBLE);
                activity_eight.setVisibility(View.VISIBLE);
                activity_nine.setVisibility(View.VISIBLE);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.back_major_header) {
            ...
            if (lanuage.equals("1") && (classnum == 0 || classnum == 1))
                startActivity(new Intent(TamilLkgUkgActivity.this, EmptyStatus.class));
            else
...
//                Log.i("DEBUG","--ID ::"+getIntent().getIntExtra("ID",0));
            ...
            if (getString(R.string.videos_tamil).equals(contentViews)) {
                Intent intent = new Intent(TamilLkgUkgActivity.this, LiveVideo.class);
...
//                    intent.putExtra("from", "live");
                ...
                Intent intent = new Intent(TamilLkgUkgActivity.this, LiveVideo1.class);
                intent.putExtra("Title", title);
                intent.putExtra("language", lanuage);
                intent.putExtra("pos", position);
                intent.putExtra("ID", getIntent().getIntExtra("ID", 0));
...
//                    intent.putExtra("from", "songs1");
                ...
                startActivity(new Intent(TamilLkgUkgActivity.this, BaseActivityExtends.class)
    ...
    private void networkStatus() {
        ...
        if (!networkStatusFinder.networkStatus(TamilLkgUkgActivity.this)) {
            Intent intent = new Intent(TamilLkgUkgActivity.this, EmptyStatus.class);
